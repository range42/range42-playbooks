...
## set by `range42-context use <codename> misp_lab`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - misp_lab.setup_networks.sh (this)   - create the SDN objects
##   - misp_lab.delete_networks.sh         - remove them, keeping the shared zone
##
