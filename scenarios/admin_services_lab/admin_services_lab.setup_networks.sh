...
## set by `range42-context use <codename> admin_services_lab`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - admin_services_lab.setup_networks.sh (this)   - create the SDN objects
##   - admin_services_lab.delete_networks.sh         - remove them, keeping the shared zone
##
