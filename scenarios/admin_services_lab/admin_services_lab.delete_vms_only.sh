...
##
## admin_services_lab.delete_vms_only.sh - destroy the admin_services_lab VM, keep templates
##
...
echo ":: stopping and deleting admin_services_lab VMs (keeping templates)..."
echo ":: admin_services_lab VMs: ${SCENARIO_VM_IDS[*]}"
echo ""
...
echo ":: redeploy with: range42-context deploy-vms  (or ./admin_services_lab.setup_vms_only.sh)"
echo ""
