...
##
## admin_services_lab.delete_all.sh - delete VMs + templates declared in this scenario's manifest
##
## ⚠ WARNING ⚠
...
##   re-deploy. Use admin_services_lab.delete_vms_only.sh instead to keep the template
##   intact.
##
