...
## set by `range42-context use <codename> demo_lab`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - demo_lab.setup_networks.sh (this)   - create the SDN objects
##   - demo_lab.delete_networks.sh         - remove them, keeping the shared zone
##
