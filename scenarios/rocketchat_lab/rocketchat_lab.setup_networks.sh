...
## set by `range42-context use <codename> rocketchat_lab`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - rocketchat_lab.setup_networks.sh (this)   - create the SDN objects
##   - rocketchat_lab.delete_networks.sh         - remove them, keeping the shared zone
##
