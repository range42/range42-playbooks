...
##
## ⚠ WARNING ⚠
##   The medium ubuntu_noble template (VMID 9232) declared in rocketchat_lab's
...
##   misp_lab, dev_deployer_ui_lab). Running this script removes 9232 - those
##   scenarios will need to re-run their 01_templates-bootstrap/ to rebuild it before re-deploy.
##   Use rocketchat_lab.delete_vms_only.sh instead to keep the template intact.
##
## Companions:
##   - rocketchat_lab.delete_vms_only.sh        - VMs only, keep template
##   - rocketchat_lab.delete_all.sh (this)      - VMs + template
##
