...
##
## ⚠ WARNING ⚠
##   The medium ubuntu_noble template (VMID 9232) declared in vaultwarden_lab's
...
##   re-deploy. Use vaultwarden_lab.delete_vms_only.sh instead to keep the template
##   intact.
##
## Companions:
##   - vaultwarden_lab.delete_vms_only.sh        - VMs only, keep template
##   - vaultwarden_lab.delete_all.sh (this)      - VMs + template
##
