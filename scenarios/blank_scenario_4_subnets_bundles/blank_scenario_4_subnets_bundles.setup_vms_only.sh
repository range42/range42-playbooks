...
##
## blank_scenario_4_subnets_bundles.setup_vms_only.sh - run main_vms_only.yml (skip template creation)
##
## Same shape as kunai_lab_bundles.setup_vms_only.sh. Templates 9221 (small)
