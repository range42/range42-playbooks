...
##
## dev_deployer_ui_lab_bundles.setup_vms_only.sh - run main_vms_only.yml (skip template creation)
##
## Same shape as kunai_lab_bundles.setup_vms_only.sh. Template 9232 (medium,
