...
##
## dev_deployer_ui_lab.setup_vms_only.sh - run main_vms_only playbook
##
## Skips the 01_init_proxmox template stage. Use this when the medium template
## 9232 is already on the Proxmox (from a prior dev_deployer_ui_lab.setup.sh run
## or from another scenario - misp_lab / blank_scenario_2_subnets / demo_lab
## build the same one).
