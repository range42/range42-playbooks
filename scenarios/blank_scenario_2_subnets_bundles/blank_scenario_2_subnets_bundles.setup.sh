...
##
## blank_scenario_2_subnets_bundles.setup.sh - run the main playbook (templates + 4 team VMs + 3 always-on admin VMs [+ optional admin tier])
##
...
## to be exported - set by `range42-context use <codename> blank_scenario_2_subnets`.
##
