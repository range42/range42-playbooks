...
## set by `range42-context use <codename> blank_scenario_4_subnets`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - blank_scenario_4_subnets.setup_networks.sh (this)   - create the SDN objects
##   - blank_scenario_4_subnets.delete_networks.sh         - remove them, keeping the shared zone
##
