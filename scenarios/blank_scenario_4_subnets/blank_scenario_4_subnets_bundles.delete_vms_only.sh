...
##
## Companions:
##   - blank_scenario_4_subnets_bundles.delete_vms_only.sh (this) - VMs only, keep templates
##   - blank_scenario_4_subnets_bundles.delete_all.sh             - VMs + this scenario's templates
##
