...
## set by `range42-context use <codename> _init_lab`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - _init_lab.setup_networks.sh (this)   - create the SDN objects
##   - _init_lab.delete_networks.sh         - remove them, keeping the shared zone
##
