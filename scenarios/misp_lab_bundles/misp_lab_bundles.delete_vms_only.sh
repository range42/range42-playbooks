...
##
## misp_lab_bundles.delete_vms_only.sh - destroy the misp_lab VMs, keep templates
##
...
##   - misp_lab_bundles.delete_all.sh             - VMs + templates
##
...
echo ":: stopping and deleting misp_lab VMs (keeping templates)..."
echo ":: misp_lab VMs: ${SCENARIO_VM_IDS[*]}"
echo ""
...
echo ":: redeploy with: range42-context deploy-vms  (or ./misp_lab_bundles.setup_vms_only.sh)"
echo ""
