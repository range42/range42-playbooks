...
##
## Same shape as kunai_lab_bundles.setup_vms_only.sh. Template 9232 is assumed
## already present on the Proxmox (built by a prior setup.sh or by another
## scenario). Used by `range42-context deploy-vms`.
##
