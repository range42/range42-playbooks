...
##   it before re-deploy.
##   Use misp_lab_bundles.delete_vms_only.sh instead to keep the template intact.
##
## Companions:
##   - misp_lab_bundles.delete_vms_only.sh        - VMs only, keep template
##   - misp_lab_bundles.delete_all.sh (this)      - VMs + template
##
