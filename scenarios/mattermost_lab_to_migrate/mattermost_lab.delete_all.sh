...
##
## ⚠ WARNING ⚠
##   The medium ubuntu_noble template (VMID 9232) declared in mattermost_lab's
...
##
## Companions:
##   - mattermost_lab.delete_vms_only.sh        - VMs only, keep template
##   - mattermost_lab.delete_all.sh (this)      - VMs + template
##
