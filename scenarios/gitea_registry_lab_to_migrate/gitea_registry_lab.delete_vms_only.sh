...
##
## gitea_registry_lab.delete_vms_only.sh - destroy the gitea_registry_lab VM, keep templates
##
...
echo ":: stopping and deleting gitea_registry_lab VMs (keeping templates)..."
echo ":: gitea_registry_lab VMs: ${SCENARIO_VM_IDS[*]}"
echo ""
...
echo ":: redeploy with: range42-context deploy-vms  (or ./gitea_registry_lab.setup_vms_only.sh)"
echo ""
