...
## set by `range42-context use <codename> gitea_registry_lab_to_migrate`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - gitea_registry_lab_to_migrate.setup_networks.sh (this)   - create the SDN objects
##   - gitea_registry_lab_to_migrate.delete_networks.sh         - remove them, keeping the shared zone
##
