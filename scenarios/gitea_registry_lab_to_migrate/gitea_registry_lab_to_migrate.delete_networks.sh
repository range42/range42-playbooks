...
##
## Companions:
##   - gitea_registry_lab_to_migrate.setup_networks.sh          - create the SDN objects
##   - gitea_registry_lab_to_migrate.delete_networks.sh (this)  - remove them, keeping the shared zone
##
