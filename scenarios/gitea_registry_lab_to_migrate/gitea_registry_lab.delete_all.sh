...
##
## gitea_registry_lab.delete_all.sh - delete VMs + templates declared in this scenario's manifest
##
## ⚠ WARNING ⚠
##   The medium ubuntu_noble template (VMID 9232) declared in gitea_registry_lab's
...
##   gitea_lab). Running this script removes 9232 - those
##   scenarios will need to re-run their 01_init_proxmox/ to rebuild it before
##   re-deploy. Use gitea_registry_lab.delete_vms_only.sh instead to keep the template
##   intact.
##
