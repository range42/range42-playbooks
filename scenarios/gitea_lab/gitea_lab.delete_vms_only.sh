...
##
## gitea_lab.delete_vms_only.sh - destroy the gitea_lab VM, keep templates
##
...
echo ":: stopping and deleting gitea_lab VMs (keeping templates)..."
echo ":: gitea_lab VMs: ${SCENARIO_VM_IDS[*]}"
echo ""
...
echo ":: redeploy with: range42-context deploy-vms  (or ./gitea_lab.setup_vms_only.sh)"
echo ""
