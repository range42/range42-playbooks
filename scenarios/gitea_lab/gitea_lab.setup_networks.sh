...
## set by `range42-context use <codename> gitea_lab`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - gitea_lab.setup_networks.sh (this)   - create the SDN objects
##   - gitea_lab.delete_networks.sh         - remove them, keeping the shared zone
##
