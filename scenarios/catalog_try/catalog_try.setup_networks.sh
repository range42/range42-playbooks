...
## set by `range42-context use <codename> catalog_try`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - catalog_try.setup_networks.sh (this)   - create the SDN objects
##   - catalog_try.delete_networks.sh         - remove them, keeping the shared zone
##
