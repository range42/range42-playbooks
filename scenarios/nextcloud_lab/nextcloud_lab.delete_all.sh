...
##
## ⚠ WARNING ⚠
##   The medium ubuntu_noble template (VMID 9232) declared in nextcloud_lab's
...
##   re-deploy. Use nextcloud_lab.delete_vms_only.sh instead to keep the template
##   intact.
##
## Companions:
##   - nextcloud_lab.delete_vms_only.sh        - VMs only, keep template
##   - nextcloud_lab.delete_all.sh (this)      - VMs + template
##
