...
## set by `range42-context use <codename> init_lab`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - init_lab.setup_networks.sh (this)   - create the SDN objects
##   - init_lab.delete_networks.sh         - remove them, keeping the shared zone
##
