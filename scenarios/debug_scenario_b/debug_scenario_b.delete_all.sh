...
##   with debug_scenario_a on the same Proxmox. Run delete_vms_only.sh instead
##   to keep the template.
##
## Companions:
##   - debug_scenario_b.delete_vms_only.sh        — VMs only, keep template
##   - debug_scenario_b.delete_all.sh (this)      — VMs + this scenario's template
##
