...
## set by `range42-context use <codename> debug_scenario_b`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - debug_scenario_b.setup_networks.sh (this)   - create the SDN objects
##   - debug_scenario_b.delete_networks.sh         - remove them, keeping the shared zone
##
