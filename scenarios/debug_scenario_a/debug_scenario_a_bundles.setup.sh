...
##
## debug_scenario_a_bundles.setup.sh - run the main playbook (template(s) + 1 lab VM [+ optional admin tier])
##
...
## to be exported - set by `range42-context use <codename> debug_scenario_a`.
##
