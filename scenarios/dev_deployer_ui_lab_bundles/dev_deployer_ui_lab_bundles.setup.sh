...
##
## dev_deployer_ui_lab_bundles.setup.sh - run the main playbook (templates + 3 dev VMs + 3 app bundles [+ optional admin tier])
##
## Same shape as kunai_lab_bundles.setup.sh / demo_lab_bundles.setup.sh (bundle-driven scenario wrappers).
...
##   ./dev_deployer_ui_lab_bundles.setup.sh -e INSTALL_WAZUH=YES
