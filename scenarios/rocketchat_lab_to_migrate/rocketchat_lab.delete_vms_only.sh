...
##
## rocketchat_lab.delete_vms_only.sh - destroy the rocketchat_lab VM, keep templates
##
...
echo ":: stopping and deleting rocketchat_lab VMs (keeping templates)..."
echo ":: rocketchat_lab VMs: ${SCENARIO_VM_IDS[*]}"
echo ""
...
echo ":: redeploy with: range42-context deploy-vms  (or ./rocketchat_lab.setup_vms_only.sh)"
echo ""
