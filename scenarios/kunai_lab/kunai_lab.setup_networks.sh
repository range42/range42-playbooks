...
## set by `range42-context use <codename> kunai_lab`.
##
## Any other argument is propagated to ansible-playbook.
##
## Companions:
##   - kunai_lab.setup_networks.sh (this)   - create the SDN objects
##   - kunai_lab.delete_networks.sh         - remove them, keeping the shared zone
##
