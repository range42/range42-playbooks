# sdn_network.delete.sdn_zone

Delete one zone. One raw API call.
...
Proxmox REFUSES to delete a zone that still holds a vnet. Empty it first.
...
- the devkit equivalent, for a shell one-liner rather than a playbook:
  `proxmox_network.*.delete_sdn_zone.to.jsons.sh`
